...
// import `logger` everywhere instead of console.*. Config lives in wonder-logger.yaml at the app root.
//
// ⚠️ Pino arg order is DATA-OBJECT-FIRST: logger.info({ id }, "msg"). Passing the message first
