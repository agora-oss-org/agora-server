// Seed a sample "tide pools" feed post owned by the seed user, with an image uploaded through the
...
const IMAGE_PATH = process.env.TIDEPOOL_IMAGE_PATH || path.join(import.meta.dirname, "images", "tidepool.jpg");
const FILENAME = "tide-pool.jpg";

// Original copy (not reproduced from any source) — a friendly demo post.
const TITLE = "Low tide treasures at the cove 🌊";
const CONTENT =
