// Seed a sample "watercolor painting" feed post owned by the seed user, with an image uploaded through the
...
//   node scripts/seeds/seed-watercolor-post.mjs
...
// DEMO_EMAIL / DEMO_PASSWORD, WATERCOLOR_IMAGE_URL.
...
const IMAGE_PATH = process.env.WATERCOLOR_IMAGE_PATH || path.join(import.meta.dirname, "images", "watercolor.jpg");
const FILENAME = "watercolor.jpg";

// Original copy (not reproduced from any source) — a friendly demo post.
const TITLE = "Watercolor basics: learning to let go 🎨";
const CONTENT =
  "The hardest lesson is doing less. Wet-on-wet washes bloom on their own if you stop poking at them, and the white of the paper is a color you can't paint back. Half my favorite marks today were happy accidents. Loosening my grip on control is the actual skill. 🖌️";
